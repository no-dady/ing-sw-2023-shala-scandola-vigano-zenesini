...
import it.polimi.client.network.ClientSocketMiddleware;

import java.io.IOException;
import java.rmi.RemoteException;

/**
 * The type Test app it.polimi.client socket.
 */
public class TestAppClientSocket {
    ...
    public static void main(String[] args) throws IOException {
        //To send the info you have to call the ServerStub's function on it.polimi.client-side
