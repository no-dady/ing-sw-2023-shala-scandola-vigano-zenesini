...
public class FourPlayersScreenController implements GenericInterface, Initializable {
    ...
    public void update() {
        ...
        HashMap<Pane, Coordinates> bookshelfMap3 = new HashMap<>();
        bookshelfMap3.put( t4_1_1, new Coordinates(1,6));
        bookshelfMap3.put( t4_3_1, new Coordinates(1,5));
        bookshelfMap3.put( t4_5_1, new Coordinates(1,4));
        bookshelfMap3.put( t4_7_1, new Coordinates(1,3));
        bookshelfMap3.put( t4_9_1, new Coordinates(1,2));
        bookshelfMap3.put( t4_11_1, new Coordinates(1,1));
        bookshelfMap3.put( t4_1_3, new Coordinates(2,6));
        bookshelfMap3.put( t4_3_3, new Coordinates(2,5));
        bookshelfMap3.put( t4_5_3, new Coordinates(2,4));
        bookshelfMap3.put( t4_7_3, new Coordinates(2,3));
        bookshelfMap3.put( t4_9_3, new Coordinates(2,2));
        bookshelfMap3.put( t4_11_3, new Coordinates(2,1));
        bookshelfMap3.put( t4_1_5, new Coordinates(3,6));
        bookshelfMap3.put( t4_3_5, new Coordinates(3,5));
        bookshelfMap3.put( t4_5_5, new Coordinates(3,4));
        bookshelfMap3.put( t4_7_5, new Coordinates(3,3));
        bookshelfMap3.put( t4_9_5, new Coordinates(3,2));
        bookshelfMap3.put( t4_11_5, new Coordinates(3,1));
        bookshelfMap3.put( t4_1_7, new Coordinates(4,6));
        bookshelfMap3.put( t4_3_7, new Coordinates(4,5));
        bookshelfMap3.put( t4_5_7, new Coordinates(4,4));
        bookshelfMap3.put( t4_7_7, new Coordinates(4,3));
        bookshelfMap3.put( t4_9_7, new Coordinates(4,2));
        bookshelfMap3.put( t4_11_7, new Coordinates(4,1));
        bookshelfMap3.put( t4_1_9, new Coordinates(5,6));
        bookshelfMap3.put( t4_3_9, new Coordinates(5,5));
        bookshelfMap3.put( t4_5_9, new Coordinates(5,4));
        bookshelfMap3.put( t4_7_9, new Coordinates(5,3));
        bookshelfMap3.put( t4_9_9, new Coordinates(5,2));
        bookshelfMap3.put( t4_11_9, new Coordinates(5,1));
        List<HashMap<Pane, Coordinates>> bookshelfTiles = List.of(bookshelfMap1, bookshelfMap2, bookshelfMap3);
