...
/**
 * The type Test app it.polimi.server socket.
 */
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        try {
            ...
            while (true) {
                ...
                //To send the info you have to call the clientSkeleton's function on the it.polimi.server-side
        ...
        {
            throw new RemoteException("Cannot create it.polimi.server socket", e);
        }
    }
